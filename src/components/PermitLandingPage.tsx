...
export default function PermitLandingPage({ headline, subheadline, includeServiceCards = true }: PermitLandingPageProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-white py-[72px] md:py-[120px] px-[5%]">
        <div className="max-w-[940px] mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8">
            {subheadline} Since 2015, we&apos;ve helped thousands of successful applicants with work permits,
            study permits, visitor visas, and immigration applications with our 8 years of expertise and RCIC certification.{' '}
                  ...
                  <p className="text-gray-700">
                    ...
                    {i === 0 ? (
                      <>
                        It&apos;s{' '}
                        <Link href="/start-your-application" className="text-[#2E735F] underline hover:no-underline">
                          free to do an assessment
                        </Link>{' '}
                        to determine your eligibility. We&apos;ll work with you to determine what type of application is likely to succeed based on your situation.
                      </>
                    ) : (
                      step.description
                    )}
