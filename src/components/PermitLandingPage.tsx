...
interface PermitLandingPageProps {
  headline: string;
  subheadline: string;
  includeServiceCards?: boolean;
}
...
const steps = [
  {
    ...
    description:
      "It's free to do an assessment to determine your eligibility. We'll work with you to determine what type of application is likely to succeed based on your situation.",
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Once documents are ready, our team submits your application within 5 business days—guaranteed. Processing times for applications depend on a number of factors that's out of our control—such as the type of permit, visa, or status you're seeking, and the number of applications being processed by the Canadian government. Generally, processing times can be as quick as a few weeks or up to several months.",
  },
  {
    question: 'What are the eligibility requirements for Canadian permanent residency?',
    answer:
      'Eligibility for Canadian permanent residency is determined by factors such as education, work experience, language proficiency, and ability to adapt to life in Canada. Common pathways to permanent residency include the Express Entry system, Provincial Nominee Programs, and Family Sponsorship.',
  },
  {
    question: 'Can I work in Canada while my immigration application is being processed?',
    answer:
      'Depending on the type of immigration application and your current immigration status, you may be eligible to work in Canada while your application is being processed. Work permits may be available for individuals with pending immigration applications, provided they meet certain criteria.',
  },
  {
    question: 'What documentation do I need to provide for a study permit application?',
    answer:
      'Documentation requirements for a study permit application typically include proof of acceptance from a Canadian educational institution, evidence of financial support, a valid passport, and any additional documents required by the Canadian government, such as medical exams or police certificates.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Family members of Canadian citizens and permanent residents may be eligible to immigrate to Canada through family sponsorship programs. These programs allow sponsors to bring spouses, common-law partners, dependent children, parents, and grandparents to Canada, subject to certain requirements and sponsorship obligations.',
  },
  {
...
export default function PermitLandingPage({
  headline,
  subheadline,
  includeServiceCards = true,
}: PermitLandingPageProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="hero-section">
        <div className="container-hero">
          ...
          <p className="explainer">
            {subheadline} Since 2015, we&apos;ve helped thousands of successful applicants with
            work permits, study permits, visitor visas, and immigration applications.{' '}
      ...
      <section className="credibility-bar">
        ...
        <div className="credibility-container">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className={`credibility-card${stat.cls ? ` ${stat.cls}` : ''}`}
            >
              <div
                className={`credibility-icon${
                  stat.cls === 'rating' || stat.cls === 'registered' ? ` ${stat.cls}` : ''
                }`}
              >
                {stat.value}
              </div>
      ...
      <section className="why-us-section">
        ...
        <div className="comparison-wrap">
          <div className="comparison-card recommended">
            <h3 className="comparison-title">VisasCanada.ca</h3>
          ...
          <div className="comparison-card not-recommended">
            <h3 className="comparison-title">Applying Yourself</h3>
            <div className="comparison-list">
      ...
      <section className="services-section">
        <div className="container-services">
          ...
          <p className="explainer">
            ...
            for free and we can help you determine what&apos;s the best path for you. No payments
            required.
          </p>
        </div>
      </section>
      ...
      <section className="faq-section">
        <div className="container-faq">
          ...
          <p className="addendum">
            <strong>
              <em>Don&apos;t see your question answered?</em>
            </strong>
            <em>
              {' '}
              <br />
              ...
              . They can help answer you based on your unique situation. It&apos;s free to get
              started.
            </em>
          </p>
        </div>
